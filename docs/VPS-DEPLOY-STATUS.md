...
| 2026-07-25 16:45:00 | `51.91.11.36`  | Caddy         | 200           | Fly destroy PENDING Tigris disambiguation: `flyctl storage list --app instaedit-login --json` not yet run from operator laptop. Full operator runbook at docs/archive/legacy-fly/FLY-DESTROY-RUNBOOK.md §1; sandbox cannot execute flyctl — gate is operator-side.
