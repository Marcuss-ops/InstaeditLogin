...
DB_API_MAX_OPEN_CONNS DB_API_MAX_IDLE_CONNS DB_API_CONN_MAX_LIFETIME_SECONDS DB_API_CONN_MAX_IDLE_TIME_SECONDS
DB_WORKER_MAX_OPEN_CONNS DB_WORKER_MAX_IDLE_CONNS DB_WORKER_CONN_MAX_LIFETIME_SECONDS DB_WORKER_CONN_MAX_IDLE_TIME_SECONDS
DB_SERVER_MAX_OPEN_CONNS DB_SERVER_MAX_IDLE_CONNS DB_SERVER_CONN_MAX_LIFETIME_SECONDS DB_SERVER_CONN_MAX_IDLE_TIME_SECONDS
