...
const TIERS: ReadonlyArray<{
...
}> = [
  {
    ...
    desc: "The guided path for anyone who wants to start earning right away. You get our pre-configured Partner Program onboarding, a personal mentor, and a proven system to reach your first payout in 30 days.",
    features: [
      "Pre-configured Partner Program onboarding path",
      "1-on-1 personal mentor on the highest-paying niches",
      "Minimal editing — AI templates draft, you approve",
  ...
  {
    level: "Level 2",
    tagline: "Semi-automated execution",
    title: "Done-For-You",
    subtitle: "No camera, no voice, no editing. You approve scripts; we do the rest.",
    ringColor: "ring-blue-400/40",
    iconColor: "text-blue-300",
    bgGradient: "from-blue-500/20 to-cyan-500/20",
    hoverBorder: "hover:border-blue-400/30",
    desc: "We create, optimize, and publish daily content for you. You review the weekly script batch; the channel generates revenue while the system runs.",
    features: [
      "Semi-automated management across 7 platforms from day one",
      "5 channels + 10 AI videos included immediately",
      "Revenue from YouTube Shorts, TikTok, Reels & sponsorships",
      "Weekly script-review checkpoint — system runs the rest",
    ],
  ...
  },
  {
    ...
    desc: "Turn one monetized channel into a full portfolio. Expand into multiple languages and niches with 90% AI-executed content and dedicated infrastructure.",
    features: [
