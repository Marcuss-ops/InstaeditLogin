      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-10 items-center">
        <div className="lg:col-span-7 xl:col-span-6 animate-fade-up">
          ...
          <h1 className="text-display-1 text-white">
            Publish <span className="text-gradient-animated">once.</span>
            <br />
            Ship to <span className="text-gradient-animated">every channel.</span>
          </h1>
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-5 animate-fade-up">
          ...
          <h2 className="text-display-2 text-white mb-5">
            One vertical render.{" "}
            <span className="text-gradient-animated">Three platforms.</span> Zero
            reuploads.
          </h2>
    ...
    <section className="relative py-24 sm:py-32 overflow-hidden bg-elevated">
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 lg:order-2 animate-fade-up">
          ...
          <h2 className="text-display-2 text-white mb-5">
            Horizontal masters,{" "}
            <span className="text-gradient-animated">shipped everywhere.</span>
          </h2>
...
/* ----------------------------------------------------------------------------
 * Who I am — hero image with darkened overlay + mission + founder message.
 * Placed right after the hero so visitors immediately understand the mission.
 * -------------------------------------------------------------------------- */
function WhoAreWe() {
  return (
      ...
      <div className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto animate-fade-up">
          ...
          <p className="text-body-lg text-zinc-300/90 max-w-[55ch] mx-auto">
            ...
            audience — so anyone, anywhere, can publish professional content
            without a studio, a team, or a big budget.
          </p>
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="animate-fade-up">
            ...
            <p className="text-body-lg text-zinc-400 max-w-[55ch] mb-6">
              ...
              shouldn't require a full production team — and publishing to
              every platform shouldn't take all day.
            </p>
            <p className="text-body-lg text-zinc-400 max-w-[55ch] mb-8">
              InstaEdit automates the entire pipeline: upload once, and we
              handle encoding, captions, thumbnails, scheduling, and
              publishing across YouTube, TikTok, Instagram, and more — so
              you can focus on what you love: creating.
            </p>
          ...
          <div className="relative animate-fade-up animation-delay-200">
            <div className="surface-glass border border-white/15 rounded-2xl p-8 relative overflow-hidden shadow-[0_30px_100px_-40px_rgba(124,58,237,0.4)]">
              ...
              />
              <div className="relative">
                <div className="text-eyebrow text-zinc-200 mb-4">
                  A Message From Our Founder
                </div>

                <p className="text-sm text-zinc-300 leading-relaxed mb-4">
                  Growing up as the child of an immigrant, I always looked for
                  ways to build something on my own. When I started creating
                  videos, I fell in love with the freedom of being my own boss
                  — setting my own schedule, chasing my own ideas.
                </p>
                <p className="text-sm text-zinc-300 leading-relaxed mb-4">
                  But I also quickly realized how hard it was to actually
                  publish everywhere. The 14-tab workflow, the re-encoding,
                  the manual captions — it felt like a full-time job just to
                  hit "post."
                </p>
                <p className="text-sm text-zinc-300 leading-relaxed mb-4">
                  That's why I started InstaEdit. It's the all-in-one video
                  publishing tool I wish I had from day one. We automate all
                  of the "business stuff" so you can spend your time doing
                  what you love — creating great content.
                </p>
                <p className="text-sm text-zinc-300 leading-relaxed mb-6">
                  We're on a mission to empower anyone to make a living
                  working for themselves, and we're grateful you're here.
                  Creating content is really hard. InstaEdit is here to help
                  you breathe just a little bit easier.
                </p>
