...
const PACKAGES: ReadonlyArray<{
...
}> = [
  {
    ...
    features: [
      ...
      "Fast-Track Partner Monetization onboarding included",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Multi-channel diversification playbook",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Monetization timelines depend on your niche and consistency, but our mentorship is built to accelerate the process as fast as possible. Plus, our Fast-Track Partner Monetization setup moves you through the Partner Program review window so you hit monetization milestones much faster."
  },
  {
  ...
  {
    q: "What does the Fast-Track Partner Monetization setup do?",
    a: "It is a pre-configured channel framework plus an indexing acceleration protocol: YouTube's algorithm starts surfacing your videos in days rather than months, anti-spam filters don't gate-keep your content, and you reach monetization milestones weeks earlier than a brand-new account. It is a structured onboarding path, not a traded asset."
  },
  {
    q: "What is the difference between the Mentorship and the Content Automation System?",
    a: "In the Mentorship Program, we teach you how to run and grow YouTube channels correctly with 1-on-1 guidance and weekly feedback. In the Content Automation System, we handle content creation, editing and publishing end-to-end — you review the weekly script batch, system runs the rest."
  },
  {
