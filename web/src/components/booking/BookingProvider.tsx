  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative w-full max-w-2xl surface-card rounded-3xl overflow-hidden shadow-[0_50px_140px_-50px_rgba(124,58,237,0.65)] animate-fade-up"
      >
        {/* Top accent ribbon — same gradient family as the marketing
            "featured" tier card so the visual grammar carries over. */}
        <div
          aria-hidden="true"
          className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-500 via-cyan-400 to-pink-400"
        />
        ...
        <button
          ...
          className="absolute top-4 right-4 z-10 inline-flex w-9 h-9 items-center justify-center rounded-full bg-white/[0.06] border border-white/10 text-zinc-300 hover:bg-white/[0.12] hover:text-white transition-colors"
        >
          <X className="w-4 h-4" />
        </button>
