...
// refreshSweepAccessTokenWindowMinutes keeps short-lived provider access
// tokens usable between user actions. Refresh tokens can remain valid for
// months while bearer tokens typically expire within an hour.
